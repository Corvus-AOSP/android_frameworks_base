...
public class SystemSettingsValidators {
    ...
    static {
	    ...
	    VALIDATORS.put(System.QS_STATUS_ICON_BACKGROUND, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.QS_HEADER_DATE_LOCATION, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(System.QS_BRIGHTNESS_SLIDER_STYLE, BOOLEAN_VALIDATOR);
    }
}
