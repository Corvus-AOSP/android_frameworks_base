    ...
    private byte[] getSystemSettings() {
        ...
        try {
            String[] settings = ArrayUtils.concatElements(String.class, SystemSettings.SETTINGS_TO_BACKUP,
                    Settings.System.SETTINGS_TO_BACKUP);
    ...
    SettingsBackupWhitelist getBackupWhitelist(Uri contentUri) {
        ...
        if (contentUri.equals(Settings.Secure.CONTENT_URI)) {
            ...
            whitelist = ArrayUtils.concatElements(String.class, SystemSettings.SETTINGS_TO_BACKUP,
                    Settings.System.LEGACY_RESTORE_SETTINGS, Settings.System.SETTINGS_TO_BACKUP);
            validators = SystemSettingsValidators.VALIDATORS;

            final Map<String, Integer> Validators = Settings.System.SETTINGS_VALIDATORS;
            // BOOLEAN_VALIDATOR == 0
            // ANY_INTEGER_VALIDATOR == 1
            // ANY_STRING_VALIDATOR == 2
            for (String key : Validators.keySet()) {
                Integer validatorId = Validators.get(key);
                if (validatorId == 0) {
