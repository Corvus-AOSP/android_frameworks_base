...
@Module
public abstract class CorvusSystemUIBinder extends SystemUIBinder {
    /**
     * Inject into CorvusServices.
     */
    @Binds
    @IntoMap
    @ClassKey(CorvusServices.class)
    public abstract SystemUI bindCorvusServices(CorvusServices sysui);
