package com.corvus.systemui.keyguard;
...
public class CorvusKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "CorvusKeyguardSliceProvider";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<CorvusKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(CorvusKeyguardSliceProvider CorvusKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(CorvusKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = CorvusKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            CorvusKeyguardSliceProvider CorvusKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                CorvusKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (CorvusKeyguardSliceProvider != null) {
                CorvusKeyguardSliceProvider.notifyChange();
            }
        }
