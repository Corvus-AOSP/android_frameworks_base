...
public class QSPanel extends LinearLayout implements Tunable {
    ...
    public static final String QS_SHOW_AUTO_BRIGHTNESS = Settings.Secure.QS_SHOW_AUTO_BRIGHTNESS;
    public static final String QS_SHOW_BRIGHTNESS_SLIDER = Settings.Secure.QS_SHOW_BRIGHTNESS_SLIDER;
    public static final String QS_BRIGHTNESS_SLIDER_POSITION = Settings.Secure.QS_BRIGHTNESS_SLIDER_POSITION;
