...
package com.android.systemui.corvus.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.corvus.header.STATUS_BAR_HEADER_UPDATE";
