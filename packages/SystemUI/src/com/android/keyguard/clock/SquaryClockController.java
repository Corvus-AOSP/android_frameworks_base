...
public class SquaryClockController implements ClockPlugin {
    ...
    private void createViews() {
        ...
        mHour = mBigClockView.findViewById(R.id.hours);
        mMinutes = mBigClockView.findViewById(R.id.minutes);
        mHourBkg = mBigClockView.findViewById(R.id.hr_bkg);
        mMinBkg = mBigClockView.findViewById(R.id.min_bkg);
